...
voc_model_id = 'ljspeech_raw_ulaw_64_275_15'      # batch_size: 64, hop_length: 275, voc_seq_len = hop_length * 15
...
voc_seq_len = hop_length * 15       # must be a multiple of hop_length
